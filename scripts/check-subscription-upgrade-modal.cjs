...
assert.match(upgradeModal, /useBottomSheet/);
assert.match(upgradeModal, /openSheet\("paymentCheckout"/);
assert.doesNotMatch(upgradeModal, /useAdminContact/);
assert.doesNotMatch(upgradeModal, /openAdminContact/);
assert.doesNotMatch(upgradeModal, /adminActivate/);
